...
myFitness.bellyData = [36.5,35.25,34.5,34.0];


myFitness.chestGoal = 42;
myFitness.chestData = [40,40.5,41.0,41.25];

myFitness.bicepsGoal = 15;
myFitness.bicepsData = [14,14.25,14.5,14.5];

myFitness.weightGoal = 200;
myFitness.weightData = [180,175, 178,178];
